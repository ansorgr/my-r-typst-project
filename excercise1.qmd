...
It would have been easier to first correct the spelling (cleaning the data) and then make it a factor (i.e. just running (2)). Note that we _must_ use the `factor()` function to set the levels.
